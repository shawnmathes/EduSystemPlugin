  ...
  public void actionPerformed(ActionEvent e) {
	  ...
	  if(e.getSource()==AddBtn)
		 {
			 System.out.println("you have chosen Add Class Button");
			   ...
			   //Check if you select class or not
				 ...
				 {
					 WarningBox NoClassWarning = new WarningBox(new JFrame(), "No Class Warning", "Please provide a class name");
					 return;
				 }
				 ...
				 if(m.find())
				 {
					 WarningBox NoClassWarning = new WarningBox(new JFrame(), "Invalid Class name", "Please use only number and letter as name");
					 return; 
				 }
				 ...
				 for(int i =0;i<currentClassList.size();i++)
				 {
					 if(!currentClassList.get(i).equals(""))
					 {
						 ...
						 if((currentClassList.get(i).equals(area.getText().toString()))||(currentClassList.get(i).toLowerCase().equals(area.getText().toString()))||(currentClassList.get(i).toUpperCase().equals(area.getText().toString())))
						 {
							 checkFlag=1;
							 WarningBox repeateClassWarning = new WarningBox(new JFrame(), "Repeat Class Warning", "This Class already exist");
						     return;
						 }
					 }
				 ...
				 if(checkFlag==0)
				 {
					 ...
					 writefile.append(area.getText().toString(), commonFilename);
					    ...
					    area.setText("");
					    ConfirmationBox confirmation = new ConfirmationBox (new JFrame(), "Success Message", "Course Created Successfully");
	  ...
	  if(e.getSource()==DeleteBtn)
	  {
		  ...
		  if((selectedCourse==null)||(selectedCourse.length()==0))
			 {
				 WarningBox NoClassWarning = new WarningBox(new JFrame(), "No Class Warning", "You have no class to delete");
				 return;
			 }
		  else
			{
			  ...
			  if(syllabus.exists())
			  {
			    ...
			    ConfirmationBox confirmation = new ConfirmationBox (new JFrame(), "Success Message", "Course Deleted Successfully");
