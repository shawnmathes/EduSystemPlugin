...
public class AdminGUIList extends JDialog implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e1) {
	  ...
	  if(e1.getSource()==DeleteBtn)
		 {
		  if((Arrays.toString(list.getSelectedValues()).equals("[]"))||(Arrays.toString(list.getSelectedValues()).equals("")))
			 {
			...
			{
				String []dropClassArray = Arrays.toString(list.getSelectedValues()).split("\\[");
